...
Membership management, class scheduling, and booking for gyms — replaces paper-based admin with one connected system.
...
Lets traders log, monitor, and review trading activity in one organized place, built for clarity and discipline.
...
### 🏗️ HDB
**Company Management & Inventory Platform**
Display website connected to live inventory via API, with an integrated WhatsApp bot for customer enquiries.

</td>
<td width="50%" valign="top">

### 🎨 NFT Generator
**Generative NFT Collection Tool**
Composites trait layers into thousands of unique images per collection — the same technique behind major NFT drops.
...
### 🏢 Auracoat
**Construction Business Management Platform**
Brings a paper-heavy industry online with integrated project, job, and operations management.
...
A dedicated day-by-day trade log that turns trading performance into something measurable and reviewable.
